...
/// <summary>
/// Lenient, nullable-returning counterpart to Momentum.Application.Common.Security.ICurrentUser,
/// used only by AppDbContext to build the global per-entity query filter (defense
/// in depth — application query/service code must still filter by UserId explicitly;
